...
int main() {
  ...
  ScoreModifier sm2[]={DOUBLE_LETTER_SCORE, NONE, NONE, NONE, NONE, TRIPLE_WORD_SCORE, NONE};
  score = highest_scoring_word_from_tiles("N?ESHRH", sm2, word);
  cout << "The highest scoring word that can be made from the tiles 'N?ESHRH'" << endl;
  ...
  ScoreModifier sm3[]={NONE, NONE, NONE, NONE, TRIPLE_LETTER_SCORE, NONE, DOUBLE_WORD_SCORE};
  score = highest_scoring_word_from_tiles("L?IEY?A", sm3, word);
  cout << "The highest scoring word that can be made from the tiles 'L?IEY?A'" << endl;
